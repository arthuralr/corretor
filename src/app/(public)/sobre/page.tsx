    ...
    <div className="container mx-auto px-4 py-12 md:py-20">
      <div className="max-w-3xl mx-auto">
        <div className="flex flex-col items-center text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-public-heading">Sobre a RealConnect</h1>
        ...
        <div className="prose prose-lg max-w-none text-public-foreground">
            <p>
                Bem-vindo à RealConnect! Somos mais do que uma imobiliária, somos facilitadores de sonhos. Nossa missão é conectar pessoas aos seus lares ideais, oferecendo um serviço personalizado, transparente e eficiente.
            </p>
            <p>
